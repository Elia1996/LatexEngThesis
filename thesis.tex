...
\newcommand{\formularef}[1]{\textbf{\textcolor{blue2}{ \textcolor{blue2}{\vref{#1}}}}}
\newcommand{\figref}[1]{\textbf{\textcolor{blue2}{Figure \textcolor{blue2}{\vref{#1}}}}}
...
TravulogMetalanguageForSVTransformation,%
Conclusion,%
FutureWorks,%
app_a,% SummaryOfArticles,%
}
...
\title{Configurable and fault tolerant Instruction Fetch for the cv32e40p core, created through a new metalanguage that allows the application of transformations to architectures described in systemverilog}
%\titolo{Configurable Fault Folerant Instruction Fetch stage for cv32e40p core}
...
%\include{FaultToleranceTemplate}
\include{TravulogMetalanguageForSVTransformation}
